 ...
 */
async function generateReport(scanRequestId, format, username) {
  try {
    ...
    const cleanedData = await cleanData(scanResults, username);
 ...
 */
async function cleanData(scanResults, username) {
  ...
  //////////////////////////////////////////////////////////////////////////
  let audit_data = await  AuditsRepo.get("660b74b044ca08fa7fc6330c");
  ...
  try {
    const customViolations = await ViolationDescriptionRepo.getCustomDescriptions(username);
